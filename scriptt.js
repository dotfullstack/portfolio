...
const slides = [{
    ...
    description: 'Developed a dynamic e-commerce store using HTML, CSS, JavaScript, React.js for the front end, and PHP for the back end, ensuring seamless user experience and secure transactions.'
},
{
    image: 'imggg/projectimg1.png',
    category: 'Streaming Website',
    title: 'ReelMageddon - Sleek Design',
    location: 'Reactjs',
    description: 'Outcrowd unveils ReelMageddon’s platform design, enhancing its strong brand with a smooth, immersive experience.'
},
{
    image: 'imggg/pro3.png',
    category: 'Booth Website',
    title: 'Framery - Minimalist Booth Design',
    location: 'Reactjs PHP GSAP',
    description: 'Framery specializes in innovative soundproof phone booths and meeting pods, providing quiet, private spaces for calls and meetings in open offices.'
},
{
    image: 'imggg/pro6.webp',
    category: 'Business',
    title: 'Puzzle Fintech Website Design',
    location: 'html css js reactjs sql gsap',
    description: 'Puzzle, an AI platform for U.S. business accounting, boosted UX with a website redesign, driving 15% growth and 2,300+ users.'
},
{
    ...
    description: 'We designed a booking app with a simple layout for easy, hassle-free apartment rentals.'
}
];
let currentSlide = 0;
